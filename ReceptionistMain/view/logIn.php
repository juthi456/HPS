...
<body>
    ...
    <main>
        <section>
            <div
                style="margin:auto;width:20%;margin-top:12rem;background-color:#3498DB;padding-left:2rem;padding-right:2rem;padding-bottom:0.5rem;border-radius: 30px;">
                ...
                <div>
                    ...
                    ?>
                    <form style="margin-left:0rem;" action="../control/logInAction.php" method="post" novalidate
                        id="lg-form" onsubmit="return isValid(this);">
                ...
                <div style="margin-top:1rem;padding-top:1rem;text-align:center;">
                    <span style="text-decoration:none;color:#e6e6e6;">Forgot Password?
                        <a style="text-decoration:none;color:#e6e6e6;" href="../view/forgotPassword.php">
                            Click Here
                        </a>
                    </span>
                    <br><br>
